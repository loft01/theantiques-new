...
export const metadata: Metadata = {
  title: 'Ricerca | The Antiques',
  description: 'Cerca nella nostra collezione di pezzi vintage e antiquariato. Trova mobili, arte, ceramiche, gioielli e altro.',
}
    ...
    <main className="min-h-screen pb-24">
      ...
      <section className="bg-bg-secondary border-b border-border-default">
        <div className="mx-auto max-w-7xl px-6 py-16">
          <h1 className="text-display text-text-primary mb-8">Ricerca</h1>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8 px-6">
              <p className="text-body text-text-secondary">
                {totalDocs === 0 ? (
                  ...
                  <>
                    Trovati <span className="text-text-primary font-medium">{totalDocs}</span>{' '}
                    {totalDocs === 1 ? 'risultato' : 'risultati'} per{' '}
  ...
  return (
    <div className="text-center py-20">
      ...
      <p className="text-body text-text-secondary max-w-md mx-auto">
        Prova a modificare i termini di ricerca o sfoglia le nostre categorie per trovare quello che cerchi.
      </p>
    </div>
  )
}
...
function EmptySearch() {
  return (
    <div className="text-center py-20">
      ...
      <p className="text-body text-text-secondary max-w-md mx-auto">
        Inserisci un termine di ricerca per trovare antiquariato, mobili, oggetti decorativi e altro.
      </p>
    </div>
  )
}
